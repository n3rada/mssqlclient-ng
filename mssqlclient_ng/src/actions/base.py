...
class BaseAction(ABC):
    ...
    def split_arguments(self, additional_arguments: str, separator: str = ",") -> List[str]:
        ...
        splitted = [arg for arg in shlex.split(additional_arguments) if arg != separator]
        logger.debug(f"Splitted arguments: {splitted}")
        return splitted

    def parse_arguments(self, additional_arguments: str) -> Tuple[Dict[str, str], List[str]]:
        named: Dict[str, str] = {}
        positional: List[str] = []
    ...
    def get_named_argument(self, named_args: Dict[str, str], name: str, default: Optional[str] = None) -> Optional[str]:
        return named_args.get(name, default)

    def get_positional_argument(self, positional_args: List[str], index: int, default: Optional[str] = None) -> Optional[str]:
