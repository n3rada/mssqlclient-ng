...
from mssqlclient_ng.src.utils.misc import generate_random_string, get_random_unused_port
...
class AdsiService:
    ...
    def __init__(self, database_context):
        ...
        self.port = get_random_unused_port()
    ...
    def _get_ldap_server_assembly(self) -> tuple[str, str]:
        ...
        decompressed_bytes = decode_and_decompress(compressed_base64)
        decompressed_hex = bytes_to_hex_string(decompressed_bytes)
